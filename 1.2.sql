...
-- and filter the results to only include students who took the course "Databases" and received at least a grade of "B+". The output of this query will be the name and ID of each student who meets the criteria: